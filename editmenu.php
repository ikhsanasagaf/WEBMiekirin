...
<?php
    include "db.php";
    $id = $_GET['id_menu'];
    $ambildata = mysqli_query($koneksi, "SELECT * FROM menu WHERE id_menu = '$id'");
...
<?php
    ...
    if($filename == ""){ //jika gambar tidak diubah
        mysqli_query($koneksi, "UPDATE menu SET nama_menu='$namamenu', deskripsi_menu='$deskripsi', harga='$harga'
        WHERE id_menu= '$id'") or die(mysqli_error($koneksi));
    ...
    if(!in_array($ext,$ekstensi) ) {
        ...
        if($ukuran < 1044070){		
            ...
            mysqli_query($koneksi, "UPDATE menu SET
                nama_menu='$namamenu', deskripsi_menu='$deskripsi', harga='$harga', gambar='$xx'
                WHERE id_menu= '$id'") or die(mysqli_error($koneksi));
                        ...
                        <div class="card">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nama_menu" placeholder="Nama Menu" value="<?php echo $data['nama_menu'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Deskripsi Menu</label>
                                    <input type="text" class="form-control" name="deskripsi_menu" placeholder="Deskripsi Menu" value="<?php echo $data['deskripsi_menu'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Harga</label>
                                    <input type="text" class="form-control" name="harga" placeholder="Harga" value="<?php echo $data['harga'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Gambar</label> <br>
                                    <img src="img/<?php echo $data['gambar']; ?>" height="200">
                                    <br>
                                    <br>
